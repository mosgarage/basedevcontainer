...
LABEL org.opencontainers.image.source https://github.com/officialmofabs/vscode-devcontainer-base
...
RUN chmod u+rwx,g+rx,o+rx \
    ...
    mkdir -p /usr/local/lib/mosgarage/hooks.d/pre-start && \
    mkdir -p /usr/local/lib/mosgarage/hooks.d/post-start
